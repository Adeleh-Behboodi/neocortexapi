# My Exercises
RENAME THIS FILE TO "Exercises - Adeleh Behboodi.md" and put the content of this file into it.
...
1. Provide the URL to the docker file. I.e.: %giturl%\Source\MyCloudProjectSample\MyCloudProject\Dockerfile
2. Provide the URL to the published image in the Docker Hub.
